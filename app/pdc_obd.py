...
Отдельный слой от диагностики блоков VAG. Работает на автомобилях, где
стандартные режимы OBD-II действительно реализованы: в США они обязательны
с 1996 года, в Европе EOBD — для бензиновых с 2001, для дизельных с 2004.
У машин с других рынков разъём может быть, а режимов нет: наличие колодки
ничего не гарантирует. Здесь живут: коды неисправностей двигателя,
